...
const Schema: z.ZodType<Prisma.GradeReportLineUncheckedUpdateManyWithoutGradeReportNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportLineUncheckedUpdateManyWithoutGradeReportNestedInputObjectSchema =
  Schema;
