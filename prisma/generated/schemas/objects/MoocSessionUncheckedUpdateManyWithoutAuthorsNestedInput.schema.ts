...
const Schema: z.ZodType<Prisma.MoocSessionUncheckedUpdateManyWithoutAuthorsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MoocSessionUncheckedUpdateManyWithoutAuthorsNestedInputObjectSchema =
  Schema;
