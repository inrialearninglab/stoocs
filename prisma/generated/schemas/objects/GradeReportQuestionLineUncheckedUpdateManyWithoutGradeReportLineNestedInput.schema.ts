...
const Schema: z.ZodType<Prisma.GradeReportQuestionLineUncheckedUpdateManyWithoutGradeReportLineNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportQuestionLineUncheckedUpdateManyWithoutGradeReportLineNestedInputObjectSchema =
  Schema;
