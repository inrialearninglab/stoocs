...
const Schema: z.ZodType<Prisma.GradeReportProblemUncheckedUpdateManyWithoutGradeReportLineNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportProblemUncheckedUpdateManyWithoutGradeReportLineNestedInputObjectSchema =
  Schema;
