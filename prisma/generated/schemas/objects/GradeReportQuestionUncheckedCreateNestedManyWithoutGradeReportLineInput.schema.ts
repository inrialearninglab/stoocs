...
const Schema: z.ZodType<Prisma.GradeReportQuestionUncheckedCreateNestedManyWithoutGradeReportLineInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportQuestionUncheckedCreateNestedManyWithoutGradeReportLineInputObjectSchema =
  Schema;
