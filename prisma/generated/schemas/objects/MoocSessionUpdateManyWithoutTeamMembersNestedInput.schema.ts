...
const Schema: z.ZodType<Prisma.MoocSessionUpdateManyWithoutTeamMembersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MoocSessionUpdateManyWithoutTeamMembersNestedInputObjectSchema =
  Schema;
