...
const Schema: z.ZodType<Prisma.MoocSessionUncheckedUpdateWithoutTeamMembersInput> =
  z
    .object({
      id: z
        .union([
...
export const MoocSessionUncheckedUpdateWithoutTeamMembersInputObjectSchema =
  Schema;
