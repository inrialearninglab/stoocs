...
const Schema: z.ZodType<Prisma.GradeReportLineUpdateWithoutGradeReportProblemsInput> =
  z
    .object({
      id: z
        .union([
...
export const GradeReportLineUpdateWithoutGradeReportProblemsInputObjectSchema =
  Schema;
