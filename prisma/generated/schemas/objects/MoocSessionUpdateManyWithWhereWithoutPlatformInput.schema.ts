...
const Schema: z.ZodType<Prisma.MoocSessionUpdateManyWithWhereWithoutPlatformInput> =
  z
    .object({
...
export const MoocSessionUpdateManyWithWhereWithoutPlatformInputObjectSchema =
  Schema;
