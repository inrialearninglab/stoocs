...
const Schema: z.ZodType<Prisma.PinnedMoocUpdateManyWithoutMoocNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => PinnedMoocUpdateManyWithWhereWithoutMoocInputObjectSchema),
        z
          .lazy(() => PinnedMoocUpdateManyWithWhereWithoutMoocInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const PinnedMoocUpdateManyWithoutMoocNestedInputObjectSchema = Schema;
