...
const Schema: z.ZodType<Prisma.AuthorUncheckedCreateNestedManyWithoutSessionsInput> =
  z
    .object({
      create: z
        .union([
...
export const AuthorUncheckedCreateNestedManyWithoutSessionsInputObjectSchema =
  Schema;
