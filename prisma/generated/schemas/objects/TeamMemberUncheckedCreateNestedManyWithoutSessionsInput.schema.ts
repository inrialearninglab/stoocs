...
const Schema: z.ZodType<Prisma.TeamMemberUncheckedCreateNestedManyWithoutSessionsInput> =
  z
    .object({
      create: z
        .union([
...
export const TeamMemberUncheckedCreateNestedManyWithoutSessionsInputObjectSchema =
  Schema;
