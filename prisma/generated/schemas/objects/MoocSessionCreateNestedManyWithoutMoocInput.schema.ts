...
const Schema: z.ZodType<Prisma.MoocSessionCreateNestedManyWithoutMoocInput> = z
  .object({
    create: z
      .union([
...
export const MoocSessionCreateNestedManyWithoutMoocInputObjectSchema = Schema;
