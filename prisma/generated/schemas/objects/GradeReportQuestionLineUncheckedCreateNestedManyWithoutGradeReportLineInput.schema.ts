...
const Schema: z.ZodType<Prisma.GradeReportQuestionLineUncheckedCreateNestedManyWithoutGradeReportLineInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportQuestionLineUncheckedCreateNestedManyWithoutGradeReportLineInputObjectSchema =
  Schema;
