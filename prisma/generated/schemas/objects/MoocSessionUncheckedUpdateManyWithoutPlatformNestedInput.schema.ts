...
const Schema: z.ZodType<Prisma.MoocSessionUncheckedUpdateManyWithoutPlatformNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MoocSessionUncheckedUpdateManyWithoutPlatformNestedInputObjectSchema =
  Schema;
