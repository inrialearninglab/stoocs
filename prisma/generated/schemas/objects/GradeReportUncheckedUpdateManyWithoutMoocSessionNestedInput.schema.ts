...
const Schema: z.ZodType<Prisma.GradeReportUncheckedUpdateManyWithoutMoocSessionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportUncheckedUpdateManyWithoutMoocSessionNestedInputObjectSchema =
  Schema;
