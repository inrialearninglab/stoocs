...
const Schema: z.ZodType<Prisma.GradeReportProblemCreateNestedManyWithoutGradeReportLineInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportProblemCreateNestedManyWithoutGradeReportLineInputObjectSchema =
  Schema;
