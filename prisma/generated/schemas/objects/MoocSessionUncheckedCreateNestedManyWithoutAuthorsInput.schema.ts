...
const Schema: z.ZodType<Prisma.MoocSessionUncheckedCreateNestedManyWithoutAuthorsInput> =
  z
    .object({
      create: z
        .union([
...
export const MoocSessionUncheckedCreateNestedManyWithoutAuthorsInputObjectSchema =
  Schema;
