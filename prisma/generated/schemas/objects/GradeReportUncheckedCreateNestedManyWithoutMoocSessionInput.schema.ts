...
const Schema: z.ZodType<Prisma.GradeReportUncheckedCreateNestedManyWithoutMoocSessionInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportUncheckedCreateNestedManyWithoutMoocSessionInputObjectSchema =
  Schema;
