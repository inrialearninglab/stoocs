...
const Schema: z.ZodType<Prisma.GradeReportProblemLineCreateNestedManyWithoutGradeReportLineInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportProblemLineCreateNestedManyWithoutGradeReportLineInputObjectSchema =
  Schema;
