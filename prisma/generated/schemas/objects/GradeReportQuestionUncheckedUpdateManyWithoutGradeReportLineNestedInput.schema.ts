...
const Schema: z.ZodType<Prisma.GradeReportQuestionUncheckedUpdateManyWithoutGradeReportLineNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportQuestionUncheckedUpdateManyWithoutGradeReportLineNestedInputObjectSchema =
  Schema;
