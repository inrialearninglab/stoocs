...
const Schema: z.ZodType<Prisma.GradeReportLineUncheckedCreateNestedManyWithoutGradeReportInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportLineUncheckedCreateNestedManyWithoutGradeReportInputObjectSchema =
  Schema;
