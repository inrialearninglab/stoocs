...
const Schema: z.ZodType<Prisma.AuthorUncheckedUpdateManyWithoutSessionsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => AuthorUpdateManyWithWhereWithoutSessionsInputObjectSchema,
          ),
          z
            .lazy(
              () => AuthorUpdateManyWithWhereWithoutSessionsInputObjectSchema,
...
export const AuthorUncheckedUpdateManyWithoutSessionsNestedInputObjectSchema =
  Schema;
