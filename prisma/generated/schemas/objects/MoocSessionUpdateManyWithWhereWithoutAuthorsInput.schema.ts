...
const Schema: z.ZodType<Prisma.MoocSessionUpdateManyWithWhereWithoutAuthorsInput> =
  z
    .object({
...
export const MoocSessionUpdateManyWithWhereWithoutAuthorsInputObjectSchema =
  Schema;
