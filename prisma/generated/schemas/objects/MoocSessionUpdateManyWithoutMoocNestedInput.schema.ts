...
const Schema: z.ZodType<Prisma.MoocSessionUpdateManyWithoutMoocNestedInput> = z
  .object({
    create: z
      .union([
...
export const MoocSessionUpdateManyWithoutMoocNestedInputObjectSchema = Schema;
