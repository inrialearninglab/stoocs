...
const Schema: z.ZodType<Prisma.TeamMemberUncheckedUpdateManyWithoutSessionsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TeamMemberUncheckedUpdateManyWithoutSessionsNestedInputObjectSchema =
  Schema;
