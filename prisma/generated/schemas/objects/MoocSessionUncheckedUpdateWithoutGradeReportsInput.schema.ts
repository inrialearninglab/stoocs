...
const Schema: z.ZodType<Prisma.MoocSessionUncheckedUpdateWithoutGradeReportsInput> =
  z
    .object({
      id: z
        .union([
...
export const MoocSessionUncheckedUpdateWithoutGradeReportsInputObjectSchema =
  Schema;
