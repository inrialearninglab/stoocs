...
const Schema: z.ZodType<Prisma.MoocSessionUpdateManyWithoutTypeNestedInput> = z
  .object({
    create: z
      .union([
...
export const MoocSessionUpdateManyWithoutTypeNestedInputObjectSchema = Schema;
