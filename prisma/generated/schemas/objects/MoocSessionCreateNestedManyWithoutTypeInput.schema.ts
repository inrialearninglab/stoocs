...
const Schema: z.ZodType<Prisma.MoocSessionCreateNestedManyWithoutTypeInput> = z
  .object({
    create: z
      .union([
...
export const MoocSessionCreateNestedManyWithoutTypeInputObjectSchema = Schema;
