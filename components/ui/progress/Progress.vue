...
const props = withDefaults(defineProps<ProgressRootProps & { class?: HTMLAttributes['class']; color?: string }>(), {
    modelValue: 0,
});
...
<template>
    ...
    >
        <ProgressIndicator
            ...
            :style="`transform: translateX(-${100 - (props.modelValue ?? 0)}%); backgroundColor: ${color}`"
        />
    </ProgressRoot>
</template>
