...
const Schema: z.ZodType<Prisma.PinnedMoocUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PinnedMoocUpdateManyWithWhereWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => PinnedMoocUpdateManyWithWhereWithoutUserInputObjectSchema,
...
export const PinnedMoocUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
