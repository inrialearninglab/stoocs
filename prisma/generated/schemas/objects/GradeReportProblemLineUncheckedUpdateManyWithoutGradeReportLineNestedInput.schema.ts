...
const Schema: z.ZodType<Prisma.GradeReportProblemLineUncheckedUpdateManyWithoutGradeReportLineNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GradeReportProblemLineUncheckedUpdateManyWithoutGradeReportLineNestedInputObjectSchema =
  Schema;
