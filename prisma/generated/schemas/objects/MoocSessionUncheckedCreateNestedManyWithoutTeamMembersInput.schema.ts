...
const Schema: z.ZodType<Prisma.MoocSessionUncheckedCreateNestedManyWithoutTeamMembersInput> =
  z
    .object({
      create: z
        .union([
...
export const MoocSessionUncheckedCreateNestedManyWithoutTeamMembersInputObjectSchema =
  Schema;
